"use client";
import { PiPrinter, PiDownloadSimple, PiX } from "react-icons/pi";
                            ...
                            <div className="grid grid-cols-6 gap-2 border-t border-gray-100 pt-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-[10px] text-gray-500 whitespace-nowrap">
                                        {(booking.travelDate || route.departureDate) 
                                            ? format(new Date(booking.travelDate || route.departureDate), 'dd MMM yy') 
                                            : "N/A"}
                                    </p>
                                </div>
                                <div>
                                ...
                                <div className="text-right">
                                    ...
                                    <p className="text-[10px] text-emerald-700 font-bold whitespace-nowrap">
                                        {(booking.travelDate || route.arrivalDate || route.departureDate) 
                            ...
                            <table className="w-full text-sm">
                                ...
                                <tbody>
                                    <tr className="border-b border-gray-50 text-[11px]">
                                        <td className="px-6 py-3 font-medium">Adult PiX 1</td>
